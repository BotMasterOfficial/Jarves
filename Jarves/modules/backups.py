...
import Jarves.modules.sql.notes_sql as sql
from Jarves import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Jarves.__main__ import DATA_IMPORT
from Jarves.modules.helper_funcs.chat_status import user_admin
from Jarves.modules.helper_funcs.alternate import typing_action

# from Jarves.modules.rules import get_rules
import Jarves.modules.sql.rules_sql as rulessql

# from Jarves.modules.sql import warns_sql as warnssql
import Jarves.modules.sql.blacklist_sql as blacklistsql
from Jarves.modules.sql import disable_sql as disabledsql

# from Jarves.modules.sql import cust_filters_sql as filtersql
# import Jarves.modules.sql.welcome_sql as welcsql
import Jarves.modules.sql.locks_sql as locksql
from Jarves.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Jarves{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Jarves{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Jarves-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Jarves{}.backup".format(chat_id))  # Cleaning file
