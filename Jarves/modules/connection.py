...
import Jarves.modules.sql.connection_sql as sql
from Jarves import dispatcher, DRAGONS, DEV_USERS
from Jarves.modules.helper_funcs import chat_status
